...
var question1 = new question({
	charName: "1.  Participar en un club de robotica.",
...
var question2 = new question({
	charName: "2. Crear las físicas de videojuegos.",
	answerOptions: ["ME INTERESA", "NO SABRÍA SI ME INTERESA" ,"NO ME INTERESA"],
	answer: 2,
	pageNumber: "page-2"
});
...
var question3 = new question({
	charName: "3. Crear una pagína con un editor de código.",
	answerOptions: ["ME INTERESA", "NO SABRÍA SI ME INTERESA" ,"NO ME INTERESA"],
	answer: 2,
	pageNumber: "page-3"
});
...
var question4 = new question({
	charName: "4. Saber sobre software y hardware.",
	answerOptions: ["ME INTERESA", "NO SABRÍA SI ME INTERESA" ,"NO ME INTERESA"],
	answer: 1,
	pageNumber: "page-4"
});
...
var question5 = new question({
	charName: "5. Proponer piezas gráficas digitales.",
	answerOptions: ["ME INTERESA", "NO SABRÍA SI ME INTERESA" ,"NO ME INTERESA"],
	answer: 0,
	pageNumber: "page-5"
});
...
var question6 = new question({
	charName: "6. Crear metodos de organización de datos.",
	answerOptions: ["ME INTERESA", "NO SABRÍA SI ME INTERESA" ,"NO ME INTERESA"],
	answer: 0,
	pageNumber: "page-6"
});
var question7 = new question({
	charName: "7. Construir los planos de una maquina.",
	answerOptions: ["ME INTERESA", "NO SABRÍA SI ME INTERESA" ,"NO ME INTERESA"],
	answer: 1,
	pageNumber: "page-7"
});
var question8 = new question({
	charName: "8. Abrir un computador y arreglar sus componentes.",
	answerOptions: ["ME INTERESA", "NO SABRÍA SI ME INTERESA" ,"NO ME INTERESA"],
	answer: 0,
	pageNumber: "page-8"
});
...
var question9 = new question({
	charName: "9. Generar páginas web.",
	answerOptions: ["ME INTERESA", "NO SABRÍA SI ME INTERESA" ,"NO ME INTERESA"],
	answer: 0,
	pageNumber: "page-9"
});
var question10 = new question({
	charName: "10. Unir circuitos",
	answerOptions: ["ME INTERESA", "NO SABRÍA SI ME INTERESA" ,"NO ME INTERESA"],
	answer: 1,
	pageNumber: "page-10"
});
...
var genQuestion = function(x){
	...
	questionsPage.append('<h1>TEST ÁREA TECNOLOGÍA </h1><hr/>');	
...
// calculate score
function showScore(){
	$('.score').append("De 1 a 10, presentas un nivel de relación con el área de Tecnología es de:" + count);
}
